...
import { componentActionMap, BlockType, IComponentActionMapKey } from '@/components/templete/constants';
import { setTextFormat, getTextFormat } from '@/components/templete/components/blocks/basic/Section/node_modules/@/components/templete/components/basic/Image/node_modules/@/components/templete/components/basic/Box/node_modules/@/modal/useArticle';
...
export const ConfigMenu = function ({ target }: { target: INodeItem<any>; }) {
  ...
  const addBitmap = useCallback(() => {
    ...
    uploader.on('success', urls => {
      addItem({ type: BlockType.BITMAP, payload: urls[0] });
    });
