...
import { getStyleBgImg, setStyleBgImg } from '@/util/utils';
  ...
  return (
    <div className={styles.property}>
      ...
      <div className={styles.listItem}>
        ...
        <div>
          <ImageUploader
            url={getStyleBgImg(style.backgroundImage || '')}
            onRemove={() => onChangeStyle('backgroundImage', 'none')}
            onSuccess={(urls: string[]) =>
              onChangeStyle('backgroundImage', setStyleBgImg(urls[0]))
            }
          />
        </div>
      </div>
