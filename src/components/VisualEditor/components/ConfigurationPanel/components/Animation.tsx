...
import { ColorPickerField, ImageUploaderField, SelectField, TextField } from '@/components/Form';
...
export function Animation() {
  ...
  return useMemo(() => {
    return (
      <SelectField label="动画" name={`${focusIdx}.style.animation`} options={animationOptions} inline />
    );
  }, [focusIdx]);
}
