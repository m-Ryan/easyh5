...
export interface IStyle {
	...
	borders?: IBorders[];
	blur?:{ _class: string; isEnabled: boolean; center: string; motionAngle: number; radius: number; saturation: number; type: number; }
}
interface IBorders {
	_class: string;
	isEnabled: boolean;
...
interface IFillsItem {
	...
	gradient?: { _class: string; elipseLength: number; from: string; gradientType: number; to: string; stops: IStopsItem[]; } 
}
...
interface IEncodedAttributes {
	...
	MSAttributedStringColorAttribute?: { _class: string; alpha: number; blue: number; green: number; red: number; }
	NSKern: number;
	NSColor: INSColor;
	NSParagraphStyle: INSParagraphStyle;
	paragraphStyle?: { _class: string; alignment: number; maximumLineHeight: number; minimumLineHeight: number; allowsDefaultTighteningForTruncation: number; }
}
...
interface IStopsItem { _class: string; position: number; color: IColor; }
